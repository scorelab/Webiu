...
import RatingsCard from "."

export default {
  title: "HotelManagementSystem/RatingsCard",
  component: RatingsCard,
  argTypes: {
    imgUrl: { control: "text" },
    userName: { control: "text" },
    experience: { control: "text" },
    ratingValue: { control: "number" },
    details: { control: "array" },
  },
}

export const ratingsCard = args => <RatingsCard {...args} />
